...
import { Container, Title, Column, TitleCadastro, SubtitleCadastro, AuxText, LoginText, Row, Wrapper } from './style';
            ...
            <Column>
                <Wrapper>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Input type="text" placeholder="Nome completo" leftIcon={<MdOutlinePersonOutline />} name="name" control={control}/>
                    ...
                    <Row>
                        <AuxText>Já tenho conta.</AuxText><LoginText>Fazer login</LoginText>
                    </Row>
